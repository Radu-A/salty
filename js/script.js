...
// Meet
const meetUrl =
  "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random?tags=meat&number=4";
// Veggie
const veggieUrl =
  "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random?tags=vegetarian&number=4";
// Vegan
const veganUrl =
  "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random?tags=vegan&number=4";
// Datos nutricionales con ID
const nutritionUrl =
  "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/660109/nutritionWidget.json";
// Opciones método get
const options = {
  method: "GET",
  headers: {
...
function printSteps(array, i) {
  ...
  array[i].analyzedInstructions[0].steps.forEach((step, j) => {
    ...
    articleBtn.innerHTML = `<button id="back-button">Back to list</button>`;
